...
const struct BattleEnvironment gBattleEnvironmentInfo[BATTLE_ENVIRONMENT_COUNT] =
{
    ...
    [BATTLE_ENVIRONMENT_LONG_GRASS] =
    {
        ...
        .palEvening = gBattleEnvironmentPalette_LongGrassEvening,
        .palNight = gBattleEnvironmentPalette_LongGrassNight,
        .battleIntroSlide = BattleIntroSlide1,
    },
    ...
    [BATTLE_ENVIRONMENT_SAND] =
    {
        ...
        .palEvening = gBattleEnvironmentPalette_SandEvening,
        .palNight = gBattleEnvironmentPalette_SandNight,
    ...
    [BATTLE_ENVIRONMENT_WATER] =
    {
        ...
        .palEvening = gBattleEnvironmentPalette_WaterEvening,
        .palNight = gBattleEnvironmentPalette_WaterNight,
        .battleIntroSlide = BattleIntroSlide2,
    },
    ...
    [BATTLE_ENVIRONMENT_POND] =
    {
        ...
        .palEvening = gBattleEnvironmentPalette_PondWaterEvening,
        .palNight = gBattleEnvironmentPalette_PondWaterNight,
        .battleIntroSlide = BattleIntroSlide1,
    },
    ...
    [BATTLE_ENVIRONMENT_PLAIN] =
    {
        ...
        .background = ENVIRONMENT_BACKGROUND(Building),
        .palette = gBattleEnvironmentPalette_Underwater,
        .palEvening = gBattleEnvironmentPalette_TallGrass,
